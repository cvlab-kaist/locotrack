...
def get_config() -> config_dict.ConfigDict:
  ...
  config.shared_module_names = ('locotrack_model',)
  ...
  config.checkpoint_dir = './snapshots/locotrack'
  config.evaluate_every = 10000
  config.save_checkpoint_interval = config.evaluate_every
